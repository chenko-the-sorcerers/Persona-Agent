-- ================================================================
-- ARUTALA PERSONA AGENT — DATABASE INITIALIZATION
-- Includes: Base schema + Reset Password fields
-- ================================================================

-- Users table (with reset password fields)
...
SELECT 'Default admin account created: admin@arutala.com / admin123' AS info;
SELECT 'IMPORTANT: Change admin password in production!' AS warning;
